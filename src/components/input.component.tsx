...
export class InputComponent extends React.Component<InputComponentProps> {
    ...
    override render(): JSX.Element {
        return <div>
            <Grid item={true}>
                <Typography className="text" variant="h5">PassCrack - Password Strength Calculator</Typography>
            </Grid>
            <Grid item={true}>
                <Typography className="text" variant="overline">Simple password strength calculator</Typography>
            </Grid>

            <Grid className="input-field-padding" item={true}>
                <TextField variant="standard" fullWidth={true} label="Type in your password" type="password" onChange={(event: EventType) => {
